            ...
            <el-card class="detail-card" shadow="hover">
              ...
              <el-descriptions :column="2" border size="small">
                ...
                <el-descriptions-item label="舰船">
                  ...
                  <span class="ship-value"> (估值: {{ formatISK(detailData.victim?.ship_value || 0) }} ISK)</span>
                </el-descriptions-item>
            ...
            <el-card class="detail-card" shadow="hover" v-if="detailData.main_attacker">
              ...
              <el-descriptions :column="2" border size="small">
                ...
                <el-descriptions-item label="舰船">
                  ...
                  <span class="ship-value"> (估值: {{ formatISK(detailData.main_attacker?.ship_value || 0) }} ISK)</span>
                </el-descriptions-item>
  ...
  if (!item.type_name && item.item_type_id) {
    ...
    try {
      ...
      if (data.success) {
        ...
        // 重新加载详情页
        if (selectedKill.value) {
          await showDetail(selectedKill.value)
        }
      } else {
